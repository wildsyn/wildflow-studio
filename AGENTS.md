...
- 内容工作台功能以 `oil-oil/dsh-oil-creator` 为基础，Mac 客户端优先，Electron 为优先技术路线；产品边界见 [产品方案](docs/product-plan.md)，固定源码与兼容证据见 [UPSTREAM](UPSTREAM.md)。不能把上游的视频流程当作所有媒体的必经阶段，也不能未经验证组合不同 DSH 版本的插件。
